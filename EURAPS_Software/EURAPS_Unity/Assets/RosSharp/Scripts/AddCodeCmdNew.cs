...
public class AddCodeCmdNew : MonoBehaviour
{
    ...
    public SPEAREDCommand[] commandTypes;
    ...
    public void addStatement(int currentStatement)
    {
        ...
        RuntimeCommand rcmd = ScriptableObject.CreateInstance<RuntimeCommand>();
        rcmd.arguments = new List<object>();
        rcmd.arguments.Add(new Vector2(215f, 215f));
        rcmd.command = this.commandTypes[0];
        ProgramStore.GetInstance().AddCommand(rcmd);
    ...
    public void addBruteStatement(int currentStatement)
    {
        ...
        rcmd.arguments = new List<object>();
        rcmd.arguments.Add(new Vector2(215f, 215f));
        rcmd.command = this.commandTypes[1];
        ProgramStore.GetInstance().AddCommand(rcmd);
